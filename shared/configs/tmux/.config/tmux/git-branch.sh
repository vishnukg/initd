...
#   \363\260\230\254  U+F062C  nf-md-source_branch         (branch icon; #7dcfff is a soft
#                     fluorescent blue, distinct from the clock pill's #7aa2f7)
dir="$1"
[[ -d "$dir" ]] || exit 0
...
printf '#[fg=#111116,bg=default]\356\202\266#[fg=#7dcfff,bg=#111116,bold]\363\260\230\254 #[fg=#9aa5ce,nobold]%s #[fg=#111116,bg=default]\356\202\264 ' "$branch"
