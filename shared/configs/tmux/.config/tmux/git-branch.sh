...
#   \363\260\230\254  U+F062C  nf-md-source_branch         (branch icon; #d670d6 is
#                     kitty's ANSI purple, the colour starship's git_branch uses)
dir="$1"
[[ -d "$dir" ]] || exit 0
...
printf '#[fg=#111116,bg=default]\356\202\266#[fg=#d670d6,bg=#111116,bold]\363\260\230\254 #[fg=#9aa5ce,nobold]%s #[fg=#111116,bg=default]\356\202\264 ' "$branch"
